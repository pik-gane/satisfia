...
class WeightedMSELoss(_Loss):
    ...
    def forward(self, input: Tensor, target: Tensor, action_probs: Tensor) -> Tensor:
        # Calculate the weight as the inverse of the action probabilities
        weights = 1.0 / action_probs
        loss = (input - target) ** 2
